module Admin
  class RoomsController < AdminController
    ...
    def index
      ...
      add_breadcrumb "Overview", admin_rooms_path
    end

    # GET /rooms/1
    # GET /rooms/1.json
    def show
      add_breadcrumb "#{@room.name}", admin_room_path(@room)
    end
    ...
    def new
      @room = Room.new
      @areas = Area.all
      add_breadcrumb "New room", new_admin_room_path
    end

    # GET /rooms/1/edit
    def edit
      @areas = Area.all
      add_breadcrumb "Edit room", edit_admin_room_path(@room)
    end
